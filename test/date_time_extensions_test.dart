...
void main() {
  group('DateTime Extensions', () {
    test('returns Epoch date', () {
      expect(DateTimeX.epoch.toDate(), DateTime(1970));
    });
    ...
    test('checks if date is first month day', () {
      ...
      expect(DateTime(2022, 7).isFirstMonthDay, isTrue);
    ...
    test('checks if date is first year day', () {
      ...
      expect(DateTime(2022).isFirstYearDay, isTrue);
    ...
    test('checks if date is last year day', () {
      ...
      expect(DateTime(2022).isLastYearDay, isFalse);
    ...
    test('checks if day of date is sunday', () {
      ...
      expect(DateTime(2022, 8).isSunday, isFalse);
    });

    test('checks if month of date is january', () {
      expect(DateTime(2022).isJanuary, isTrue);
      expect(DateTime(2022, 2).isJanuary, isFalse);
    });

    test('checks if month of date is february', () {
      expect(DateTime(2022, 2).isFebruary, isTrue);
      expect(DateTime(2022, 3).isFebruary, isFalse);
    });

    test('checks if month of date is march', () {
      expect(DateTime(2022, 3).isMarch, isTrue);
      expect(DateTime(2022, 4).isMarch, isFalse);
    });

    test('checks if month of date is april', () {
      expect(DateTime(2022, 4).isApril, isTrue);
      expect(DateTime(2022, 5).isApril, isFalse);
    });

    test('checks if month of date is may', () {
      expect(DateTime(2022, 5).isMay, isTrue);
      expect(DateTime(2022, 6).isMay, isFalse);
    });

    test('checks if month of date is june', () {
      expect(DateTime(2022, 6).isJune, isTrue);
      expect(DateTime(2022, 7).isJune, isFalse);
    });

    test('checks if month of date is july', () {
      expect(DateTime(2022, 7).isJuly, isTrue);
      expect(DateTime(2022, 8).isJuly, isFalse);
    });

    test('checks if month of date is august', () {
      expect(DateTime(2022, 8).isAugust, isTrue);
      expect(DateTime(2022, 9).isAugust, isFalse);
    });

    test('checks if month of date is september', () {
      expect(DateTime(2022, 9).isSeptember, isTrue);
      expect(DateTime(2022, 10).isSeptember, isFalse);
    });

    test('checks if month of date is october', () {
      expect(DateTime(2022, 10).isOctober, isTrue);
      expect(DateTime(2022, 11).isOctober, isFalse);
    });

    test('checks if month of date is november', () {
      expect(DateTime(2022, 11).isNovember, isTrue);
      expect(DateTime(2022, 12).isNovember, isFalse);
    });

    test('checks if month of date is december', () {
      expect(DateTime(2022, 12).isDecember, isTrue);
      expect(DateTime(2022).isDecember, isFalse);
    });
    ...
    test('checks if dates are equal up to year', () {
      ...
      expect(
        DateTime(2022, 12).isAtSameYearAs(
          DateTime(2021),
        ),
        isFalse,
      );
    ...
    test('checks if dates are equal up to month', () {
      expect(
        DateTime(2022, 12).isAtSameMonthAs(
          DateTime(2022, 12, 15),
        ),
        isTrue,
      );
    ...
    test('returns age', () {
      ...
      expect(DateTime(2013).age.length, 4);
      expect(() => DateTimeX.now.nextYear.age, throwsArgumentError);
    });

    test('returns day of the year', () {
      expect(DateTime(2022).yearDay, 1);
      expect(DateTime(2022, 12, 30).yearDay, 364);
    });

    test('returns number of days in month of date', () {
      expect(DateTime(2022, 6).monthLength, 30);
      expect(DateTime(2022, 7).monthLength, 31);
    });

    test('returns number of days in year of date', () {
      expect(DateTime(2020, 6).yearLength, 366);
      expect(DateTime(2022, 7).yearLength, 365);
    });
    ...
    test('returns time until date', () {
      ...
      expect(
        DateTime(2013, 3).timeUntil(DateTime(2015)).toString(),
        '[1, 10, 0, 0]',
      );
      expect(
        () => DateTime(2015, 3).timeUntil(DateTime(2013)),
        throwsArgumentError,
      );
    });
    ...
    test('returns years until date', () {
      ...
      expect(
        DateTime(2013, 3).yearsUntil(
          DateTime(2016),
        ),
        2,
      );
      expect(
        () => DateTime(2015, 3).yearsUntil(DateTime(2013)),
        throwsArgumentError,
      );
    });
    ...
    test('returns months until date', () {
      ...
      expect(
        DateTime(2013, 3).monthsUntil(
          DateTime(2016),
        ),
        34,
      );
      expect(
        () => DateTime(2015, 3).monthsUntil(DateTime(2013)),
        throwsArgumentError,
      );
    });
    ...
    test('returns weeks until date', () {
      ...
      expect(
        DateTime(2013, 3).weeksUntil(
          DateTime(2013, 3, 18),
        ),
        2,
      );
      expect(
        () => DateTime(2015, 3).weeksUntil(DateTime(2013)),
        throwsArgumentError,
      );
    });
    ...
    test('returns days until date', () {
      expect(
        DateTime(2013, 3).daysUntil(
          DateTime(2013, 3, 18),
        ),
        17,
      );
      expect(
        () => DateTime(2015, 3).daysUntil(DateTime(2013)),
        throwsArgumentError,
      );
    });
    ...
    test('returns hours until date', () {
      ...
      expect(
        () => DateTime(2015, 3).hoursUntil(DateTime(2013)),
        throwsArgumentError,
      );
    });
    ...
    test('returns minutes until date', () {
      ...
      expect(
        () => DateTime(2015, 3).minutesUntil(DateTime(2013)),
        throwsArgumentError,
      );
    });
    ...
    test('returns seconds until date', () {
      ...
      expect(
        () => DateTime(2015, 3).secondsUntil(DateTime(2013)),
        throwsArgumentError,
      );
    });
    ...
    test('returns milliseconds until date', () {
      ...
      expect(
        () => DateTime(2015, 3).millisecondsUntil(DateTime(2013)),
        throwsArgumentError,
      );
    });
    ...
    test('returns microseconds until date', () {
      ...
      expect(
        () => DateTime(2015, 3).microsecondsUntil(DateTime(2013)),
        throwsArgumentError,
      );
    });
